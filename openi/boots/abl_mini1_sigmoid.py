...
# 任务：消融[mini1] Sigmoid score head，3 种子
...
SPEC = {'name': 'abl_mini1_sigmoid', 'dataset': 'mini', 'k_shot': 1, 'config': 'configs/ablations/mini1_sigmoid.yaml', 'seeds': [42, 123, 456], 'n_classes': 100, 'method': 'abl_mini1_sigmoid', 'cross_eval': {}, 'desc': '消融[mini1] Sigmoid score head，3 种子'}
