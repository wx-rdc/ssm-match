...
# 任务：消融[mini1] Forward scan only，3 种子
...
SPEC = {'name': 'abl_mini1_fwd', 'dataset': 'mini', 'k_shot': 1, 'config': 'configs/ablations/mini1_fwd.yaml', 'seeds': [42, 123, 456], 'n_classes': 100, 'method': 'abl_mini1_fwd', 'cross_eval': {}, 'desc': '消融[mini1] Forward scan only，3 种子'}
