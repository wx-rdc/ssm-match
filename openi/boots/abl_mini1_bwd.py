...
# 任务：消融[mini1] Backward scan only，3 种子
...
SPEC = {'name': 'abl_mini1_bwd', 'dataset': 'mini', 'k_shot': 1, 'config': 'configs/ablations/mini1_bwd.yaml', 'seeds': [42, 123, 456], 'n_classes': 100, 'method': 'abl_mini1_bwd', 'cross_eval': {}, 'desc': '消融[mini1] Backward scan only，3 种子'}
