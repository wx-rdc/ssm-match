...
# 任务：消融[mini1] State dim Ns=32，3 种子
...
SPEC = {'name': 'abl_mini1_ns32', 'dataset': 'mini', 'k_shot': 1, 'config': 'configs/ablations/mini1_ns32.yaml', 'seeds': [42, 123, 456], 'n_classes': 100, 'method': 'abl_mini1_ns32', 'cross_eval': {}, 'desc': '消融[mini1] State dim Ns=32，3 种子'}
