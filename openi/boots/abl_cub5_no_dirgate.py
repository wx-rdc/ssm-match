...
# 任务：消融[cub5] Symmetric fusion，3 种子
...
SPEC = {'name': 'abl_cub5_no_dirgate', 'dataset': 'cub', 'k_shot': 5, 'config': 'configs/ablations/cub5_no_dirgate.yaml', 'seeds': [42, 123, 456], 'n_classes': 200, 'method': 'abl_cub5_no_dirgate', 'cross_eval': {}, 'desc': '消融[cub5] Symmetric fusion，3 种子'}
