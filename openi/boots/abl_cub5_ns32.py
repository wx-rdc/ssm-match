...
# 任务：消融[cub5] State dim Ns=32，3 种子
...
SPEC = {'name': 'abl_cub5_ns32', 'dataset': 'cub', 'k_shot': 5, 'config': 'configs/ablations/cub5_ns32.yaml', 'seeds': [42, 123, 456], 'n_classes': 200, 'method': 'abl_cub5_ns32', 'cross_eval': {}, 'desc': '消融[cub5] State dim Ns=32，3 种子'}
