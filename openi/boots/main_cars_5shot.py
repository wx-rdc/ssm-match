...
SPEC = {'name': 'main_cars_5shot', 'dataset': 'cars', 'k_shot': 5, 'config': 'configs/cars_5shot.yaml', 'seeds': [42, 123, 456, 2026, 777], 'n_classes': 196, 'method': 'main_cars_5shot', 'cross_eval': {}, 'desc': '主结果 cars 5-shot，5 种子，训练+终评'}
