...
# 任务：消融[cub5] Backward scan only，3 种子
...
SPEC = {'name': 'abl_cub5_bwd', 'dataset': 'cub', 'k_shot': 5, 'config': 'configs/ablations/cub5_bwd.yaml', 'seeds': [42, 123, 456], 'n_classes': 200, 'method': 'abl_cub5_bwd', 'cross_eval': {}, 'desc': '消融[cub5] Backward scan only，3 种子'}
