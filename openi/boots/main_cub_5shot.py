...
SPEC = {'name': 'main_cub_5shot', 'dataset': 'cub', 'k_shot': 5, 'config': 'configs/cub_5shot.yaml', 'seeds': [42, 123, 456, 2026, 777], 'n_classes': 200, 'method': 'main_cub_5shot', 'cross_eval': {}, 'desc': '主结果 cub 5-shot，5 种子，训练+终评'}
