...
SPEC = {'name': 'main_cars_1shot', 'dataset': 'cars', 'k_shot': 1, 'config': 'configs/cars_1shot.yaml', 'seeds': [42, 123, 456, 2026, 777], 'n_classes': 196, 'method': 'main_cars_1shot', 'cross_eval': {}, 'desc': '主结果 cars 1-shot，5 种子，训练+终评'}
