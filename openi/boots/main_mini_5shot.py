...
# 任务：主结果 mini 5-shot，5 种子，训练+终评+CIFAR-FS 跨域评测
...
SPEC = {'name': 'main_mini_5shot', 'dataset': 'mini', 'k_shot': 5, 'config': 'configs/mini_5shot.yaml', 'seeds': [42, 123, 456, 2026, 777], 'n_classes': 100, 'method': 'main_mini_5shot', 'cross_eval': {'cifar_fs': 'configs/mini_5shot.yaml'}, 'desc': '主结果 mini 5-shot，5 种子，训练+终评+CIFAR-FS 跨域评测'}
