...
# 任务：消融[mini1] Single scale 14x14，3 种子
...
SPEC = {'name': 'abl_mini1_scale_f2', 'dataset': 'mini', 'k_shot': 1, 'config': 'configs/ablations/mini1_scale_f2.yaml', 'seeds': [42, 123, 456], 'n_classes': 100, 'method': 'abl_mini1_scale_f2', 'cross_eval': {}, 'desc': '消融[mini1] Single scale 14x14，3 种子'}
