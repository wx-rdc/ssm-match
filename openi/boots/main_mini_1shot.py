...
# 任务：主结果 mini 1-shot，5 种子，训练+终评+CIFAR-FS 跨域评测
...
SPEC = {'name': 'main_mini_1shot', 'dataset': 'mini', 'k_shot': 1, 'config': 'configs/mini_1shot.yaml', 'seeds': [42, 123, 456, 2026, 777], 'n_classes': 100, 'method': 'main_mini_1shot', 'cross_eval': {'cifar_fs': 'configs/mini_1shot.yaml'}, 'desc': '主结果 mini 1-shot，5 种子，训练+终评+CIFAR-FS 跨域评测'}
