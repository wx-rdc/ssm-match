...
# 任务：消融[cub5] Forward scan only，3 种子
...
SPEC = {'name': 'abl_cub5_fwd', 'dataset': 'cub', 'k_shot': 5, 'config': 'configs/ablations/cub5_fwd.yaml', 'seeds': [42, 123, 456], 'n_classes': 200, 'method': 'abl_cub5_fwd', 'cross_eval': {}, 'desc': '消融[cub5] Forward scan only，3 种子'}
