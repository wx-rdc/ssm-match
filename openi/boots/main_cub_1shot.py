...
SPEC = {'name': 'main_cub_1shot', 'dataset': 'cub', 'k_shot': 1, 'config': 'configs/cub_1shot.yaml', 'seeds': [42, 123, 456, 2026, 777], 'n_classes': 200, 'method': 'main_cub_1shot', 'cross_eval': {}, 'desc': '主结果 cub 1-shot，5 种子，训练+终评'}
