...
# 任务：消融[cub5] w/o evidence gate，3 种子
...
SPEC = {'name': 'abl_cub5_no_evigate', 'dataset': 'cub', 'k_shot': 5, 'config': 'configs/ablations/cub5_no_evigate.yaml', 'seeds': [42, 123, 456], 'n_classes': 200, 'method': 'abl_cub5_no_evigate', 'cross_eval': {}, 'desc': '消融[cub5] w/o evidence gate，3 种子'}
