...
# 任务：消融[mini1] w/o [SEP] separators，3 种子
...
SPEC = {'name': 'abl_mini1_no_sep', 'dataset': 'mini', 'k_shot': 1, 'config': 'configs/ablations/mini1_no_sep.yaml', 'seeds': [42, 123, 456], 'n_classes': 100, 'method': 'abl_mini1_no_sep', 'cross_eval': {}, 'desc': '消融[mini1] w/o [SEP] separators，3 种子'}
